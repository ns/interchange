...
public class Pathfinder {
	...
	// dimensions.
	// // Adapts for corners and wrap-around but at a cost of speed - only for
	// init
	//
	...
	//
	// /*
	// * // Just some notes incase I have to remove the array method of building
	// a
	// * map public ArrayList createCuboidNodes(int w, int h, int d, float
	// scale){
	// * ArrayList world = new ArrayList(); int totalLength = w * h * d; for(int
	// i =
	// * 0; i < totalLength; i++){ float x = offsetX + ((i % (w * h)) % w) *
	// scale;
	// * float y = offsetY + ((i % (w * h)) / w) * scale; float z = offsetZ + i
	// / (w *
	...
	// }
	//
	// // The next two functions are shortcut methods for disconnecting
	// unwalkables
	//
	...
	// //
	//
	// // Faster than running ArrayList.contains - we only need the reference,
	// not an
	// // object match
	//
	...
	// }
	//
	// // Faster than running ArrayList.indexOf - we only need the reference,
	// not an
	// // object match
	//
	...
	// }
	//
	// // Returns an n-dimensional arrayList from a point on a line of units
	// given an
	// // n-dimensional space
	//
	...
	// }
	//
	// // Returns a point on a line of units from an n-dimensional arrayList in
	// an
	// // n-dimensional space
	//
